# Generated by Django 2.0.2 on 2018-04-25 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='topics', to='main.Board')),
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='posts', to='main.Topic'),
        ),
        migrations.AddField(
            model_name='post',
            name='updated_by',
